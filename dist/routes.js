...
const GetLast3MessagesController_ts_1 = require("./controllers/GetLast3MessagesController.ts");
...
router.get("/messages/last3", new GetLast3MessagesController_ts_1.GetLast3MessagesController().handle);
